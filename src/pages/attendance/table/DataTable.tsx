                  ...
                  <TableCell>
                    {record.status !== "Absent" ? (
                      <div className="flex items-center gap-2 text-slate-600">
                        ...
                        <span className="font-bold text-xs">{record.checkIn} — {record.checkOut}</span>
                      </div>
                    ) : (
                      <span className="text-slate-300 font-bold text-xs italic">No hours logged</span>
                    )}
                  </TableCell>
                  ...
                  <TableCell>
                    {record.notes ? (
                      <div className="flex items-center gap-1.5 text-emerald-600">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-tighter">Has Note</span>
                      </div>
                    ) : (
